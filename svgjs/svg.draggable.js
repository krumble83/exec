...
;(function() {
  ...
  DragHandler.prototype.drag = function(e){
	...
	*/
    ...
    if (typeof c == 'function') {
	  ...
	  var oldcoord = c.call(this.el, this.el.x(), this.el.y(), this.m);
	  ...
	  //throw event only if coords have changed
	  if(oldcoord.x != this.el.x() || oldcoord.y != this.el.y()){
		this.el.fire('dragmove', {
			event: e
		  , p: p
		  , m: this.m
  ...
  SVG.extend(SVG.Element, SVG.G, {
    ...
    draggable: function(value, constraint) {
      ...
      this.mDragHandler = this.remember('_draggable') || new DragHandler(this)
