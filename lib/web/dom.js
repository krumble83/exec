;exLIB.package('web.dom', function(pack){
	...
	ev.Member('target', 'web.dom.element');
	...
	***************************************************/
	...
	n.Output('elements', 'web.dom.element[]');
	...
	***************************************************/
	...
	n = pack.Node('appendchild', 'appendChild()')
		...
		.MakeEntry().MakeExit();
	n.Input('parent', 'web.dom.element');
	n.Input('child', 'web.dom.element', 'Child [0]');
	...
	n = pack.Node('appendchildsarray', 'appendChildsArray()')
		...
		.MakeEntry().MakeExit();
	n.Input('parent', 'web.dom.element');
	n.Input('childs', 'web.dom.element[]');
	...
	n.Input('node', 'web.dom.element');
	n.Output('parent', 'web.dom.element');

	n = pack.Node('children', 'Get Childrens')
		.Import('tpl.node.pure')
		.Keywords('childs,childrens,children')
	n.Input('parent', 'web.dom.element');
	n.Output('childs', 'web.dom.element[]');

	n = pack.Node('firstChild', 'firstChild')
		.Import('tpl.node.pure')
		.Keywords('child,children')
	n.Input('parent', 'web.dom.element');
	n.Output('firstChild', 'web.dom.element');
	
	n = pack.Node('lastChild', 'lastChild')
		.Import('tpl.node.pure')
		.Keywords('child,children')
	n.Input('parent', 'web.dom.element');
	n.Output('lastChild', 'web.dom.element');
	...
	***************************************************/
	...
	n = pack.Node('nextSibling', 'nextSibling')
		.Import('tpl.node.pure')
	n.Input('node', 'web.dom.element');
	n.Output('nextSibling', 'web.dom.element');
	
	n = pack.Node('prevSibling', 'prevSibling')
		.Import('tpl.node.pure')
	n.Input('node', 'web.dom.element');
	n.Output('prevSibling', 'web.dom.element');
