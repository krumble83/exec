;exLIB.package('core.date', function(pack){
	...
	exLIB.package('core.type', function(p){
		...
		s.Pin('year', 'core.type.int', 'Year');
		s.Pin('month', 'core.type.int', 'Month');
		s.Pin('day', 'core.type.int', 'Day');
		s.Pin('hour', 'core.type.int', 'Hour');
		s.Pin('minutes', 'core.type.int', 'Minute');
		s.Pin('seconds', 'core.type.int', 'Seconds');
