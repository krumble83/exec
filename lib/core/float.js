...
******************************************************************/	
	...
	n = pack.Node('add', 'Float + Float').Import('special.tpl.add');
	n.Input('in1', 'core.type.float');
	n.Input('in2', 'core.type.float');
	n.Output('out', 'core.type.float');
	
	pack.Node('substract').Import('add').Import('special.tpl.sub').Title('Float - Float');
	pack.Node('multiply').Import('add').Import('special.tpl.mul').Title('Float x Float');
	pack.Node('divide').Import('add').Import('special.tpl.div').Title('Float / Float');
	pack.Node('modulo').Import('add').Import('special.tpl.mod').Title('Float % Float');
...
******************************************************************/	
	...
	n = pack.Node('equal', 'Equal (Float)').Import('special.tpl.eq');
	n.Input('a', 'core.type.float');
	n.Input('b', 'core.type.float');
	n.Output('out', 'core.type.bool');
	
	pack.Node('lt').Import('equal').Import('special.tpl.lt').Title('Lower Than (Float)');
	pack.Node('gt').Import('equal').Import('special.tpl.gt').Title('Gretter Than (Float)');
	pack.Node('lte').Import('equal').Import('special.tpl.lte').Title('Lower Than or Equal (Float)');
	pack.Node('gte').Import('equal').Import('special.tpl.gte').Title('Gretter Than or Equal (Float)');
	pack.Node('neq').Import('equal').Import('special.tpl.neq').Title('Not Equal (Float)');	
