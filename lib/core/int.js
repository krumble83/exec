...
******************************************************************/	
	...
	n = pack.Node('add', 'Int + Int').Import('tpl.node.add');
	n.Input('in1', 'core.type.int');
	n.Input('in2', 'core.type.int');
	n.Output('out', 'core.type.int');
	
	pack.Node('substract').Import('add').Import('tpl.node.sub').Title('Int - Int');
	pack.Node('multiply').Import('add').Import('tpl.node.mul').Title('Int x Int');
	pack.Node('divide').Import('add').Import('tpl.node.div').Title('Int / Int');
	pack.Node('modulo').Import('add').Import('tpl.node.mod').Title('Int % Int');
