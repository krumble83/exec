...
exLIB.package('special', function(pack){
	...
	pack.Node('tpl.eq').Import('core.operator').Keywords('equivalent,==,equal').Subtitle('==').Symbol('lib/img/op.eq.png');
	pack.Node('tpl.lt').Import('core.operator').Keywords('lt,<').Subtitle('<').Symbol('lib/img/op.lt.png');
	pack.Node('tpl.gt').Import('core.operator').Keywords('gt,>').Subtitle('>').Symbol('lib/img/op.gt.png');
	pack.Node('tpl.lte').Import('core.operator').Keywords('lte,<=').Subtitle('<=').Symbol('lib/img/op.lte.png');
	pack.Node('tpl.gte').Import('core.operator').Keywords('gte,>=').Subtitle('>=').Symbol('lib/img/op.gte.png');
	pack.Node('tpl.neq').Import('core.operator').Keywords('neq,<>,!=').Subtitle('<>').Symbol('lib/img/op.neq.png');

	pack.Node('tpl.add').Import('core.operator').Keywords('add,+').Subtitle('+').Symbol('lib/img/op.add.png');
	pack.Node('tpl.sub').Import('core.operator').Keywords('substract,-').Subtitle('-').Symbol('lib/img/op.sub.png');
	pack.Node('tpl.mul').Import('core.operator').Keywords('multiply,x,*').Subtitle('*').Symbol('lib/img/op.mul.png');
	pack.Node('tpl.div').Import('core.operator').Keywords('divide,/').Subtitle('/').Symbol('lib/img/op.div.png');
	pack.Node('tpl.mod').Import('core.operator').Keywords('modulo,%').Subtitle('%').Symbol('lib/img/op.mod.png');
