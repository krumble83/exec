...
/******************************************************************
	Bitwise Operators
******************************************************************/	
	n = pack.NodeTpl('op.not').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.not.png').Keywords('not,!').Subtitle('NOT').Title('*1 NOT *1');
	n.Input('a', '*1', ' ');
	n.Output('output', '*1');

	n = pack.NodeTpl('op.and').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.and.png').Keywords('and,&').Subtitle('AND').Title('*1 AND *1');
	n.Input('a', '*1', ' ');
	n.Input('b', '*1', ' ');
	n.Output('output', '*1');

	n = pack.NodeTpl('op.nand').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.nand.png').Keywords('nand').Subtitle('NAND').Title('*1 NAND *1');
	n.Input('a', '*1', ' ');
	n.Input('b', '*1', ' ');
	n.Output('output', '*1');

	n = pack.NodeTpl('op.or').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.or.png').Keywords('or,|').Subtitle('OR').Title('*1 OR *1');
	n.Input('a', '*1', ' ');
	n.Input('b', '*1', ' ');
	n.Output('output', '*1');

	n = pack.NodeTpl('op.nor').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.nor.png').Subtitle('NOR').Title('*1 NOR *1');
	n.Input('a', '*1', ' ');
	n.Input('b', '*1', ' ');

	n = pack.NodeTpl('op.xor').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.xor.png').Subtitle('XOR').Title('*1 XOR *1');
	n.Input('a', '*1', ' ');
	n.Input('b', '*1', ' ');
	
	n = pack.NodeTpl('op.xnor').Ctor('NodeOp').Color('#555').Symbol('lib/img/op.xnor.png').Subtitle('XNOR').Title('*1 XNOR *1');
	n.Input('a', '*1', ' ');
	n.Input('b', '*1', ' ');
